...
export default function Faq() {
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Is ConvertSnap completely free?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. ConvertSnap is 100% free to use with no hidden fees, no premium plan, and no credit card required. All four tools — Web to PDF, Web to Image, HTML to PDF, and HTML to Image — are permanently free."
        }
      },
      {
        "@type": "Question",
        "name": "Do I need to create an account to use ConvertSnap?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "No account is needed. Just open the tool, paste your URL or HTML code, and download your file. There is no signup, no email, and no password required."
        }
      },
      {
        "@type": "Question",
        "name": "How long are my converted files stored on your server?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "All converted files are automatically deleted from our servers after 60 minutes. We do not store any of your files permanently."
        }
      },
      {
        "@type": "Question",
        "name": "Does ConvertSnap support JavaScript-heavy websites?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. ConvertSnap uses a full headless browser to render pages, which means JavaScript, React, Vue, and Angular websites are fully rendered before conversion."
        }
      },
      {
        "@type": "Question",
        "name": "Is there an API available for developers?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. ConvertSnap offers a free REST API. Visit convertsnap.net/documentation for full API usage instructions and to get your free API key."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>ConvertSnap FAQ & Support — Common Questions Answered | convertsnap.net</title>
        <meta name="description" content="Frequently asked questions about ConvertSnap. Get answers about free PDF conversion, image output, HTML support, API access, file privacy, and more. Free tool at convertsnap.net." />
        <meta name="keywords" content="convertsnap faq, web to pdf questions, html to pdf support, convertsnap help, pdf converter questions, free converter support" />
        <link rel="canonical" href="https://www.convertsnap.net/faq" />
        
        <meta property="og:title" content="ConvertSnap FAQ — All Your Questions Answered" />
        <meta property="og:description" content="Get answers to common questions about ConvertSnap's free PDF and image conversion tools." />
        <meta property="og:url" content="https://www.convertsnap.net/faq" />
          ...
          <section className="bg-slate-900 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden shadow-xl mb-12">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Link to="/documentation" className="inline-flex items-center justify-center h-14 px-8 rounded-xl bg-white/10 text-white text-lg font-bold border border-white/20 hover:bg-white/20 transition-all shadow-sm">
