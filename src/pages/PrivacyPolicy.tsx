...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy — ConvertSnap.net</title>
        <meta name="description" content="ConvertSnap's Privacy Policy. Learn how we handle your data, files, and personal information. We collect minimal data and auto-delete all converted files after 60 minutes." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.convertsnap.net/privacy" />
        
        <meta property="og:title" content="Privacy Policy — ConvertSnap.net" />
        <meta property="og:url" content="https://www.convertsnap.net/privacy" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-border p-8 md:p-12 mb-12 prose prose-slate max-w-none prose-headings:text-text-primary prose-a:text-primary">
            ...
            <section className="mb-10">
              ...
              <p>
                We use minimal cookies for basic site functionality. See our <Link to="/cookies">Cookie Policy</Link> for full details.
              </p>
            </section>
