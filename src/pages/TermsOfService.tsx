...
export default function TermsOfService() {
  ...
  return (
    <>
      <Helmet>
        <title>Terms of Service — ConvertSnap.net</title>
        <meta name="description" content="Read ConvertSnap's Terms of Service. By using our free PDF and image conversion tools, you agree to these terms. Simple, clear, and fair terms for all users." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.convertsnap.net/terms" />
