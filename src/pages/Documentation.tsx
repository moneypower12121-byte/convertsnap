...
export default function Documentation() {
  ...
  return (
    <>
      <Helmet>
        <title>ConvertSnap Documentation — How to Use All Tools | convertsnap.net</title>
        <meta name="description" content="Complete guide to using ConvertSnap free tools. Learn how to convert websites and HTML to PDF or image, use the API, and get the best output quality. Full documentation at convertsnap.net." />
        <meta name="keywords" content="convertsnap documentation, how to use web to pdf, html to pdf guide, convertsnap api docs, url to pdf tutorial, web converter guide" />
        <link rel="canonical" href="https://www.convertsnap.net/documentation" />
        
        <meta property="og:title" content="ConvertSnap Docs — Complete Tool Documentation" />
        <meta property="og:description" content="Step-by-step guides for all ConvertSnap tools. Web to PDF, Web to Image, HTML to PDF, HTML to Image, and API usage." />
        <meta property="og:url" content="https://www.convertsnap.net/documentation" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-border p-8 md:p-12 mb-12">
            ...
            <section id="web-to-pdf" className="mb-16 scroll-mt-24">
              ...
              <div className="text-text-secondary mb-6">
                <ol className="list-decimal list-outside ml-5 space-y-2 mb-6">
                  <li>Go to <Link to="/web-to-pdf" className="text-primary hover:underline">convertsnap.net/web-to-pdf</Link></li>
            ...
            <section id="web-to-image" className="mb-16 scroll-mt-24">
              ...
              <div className="text-text-secondary mb-6">
                <ol className="list-decimal list-outside ml-5 space-y-2 mb-6">
                  <li>Go to <Link to="/web-to-image" className="text-primary hover:underline">convertsnap.net/web-to-image</Link></li>
            ...
            <section id="html-to-pdf" className="mb-16 scroll-mt-24">
              ...
              <div className="text-text-secondary mb-6">
                <ol className="list-decimal list-outside ml-5 space-y-2 mb-6">
                  <li>Go to <Link to="/html-to-pdf" className="text-primary hover:underline">convertsnap.net/html-to-pdf</Link></li>
            ...
            <section id="html-to-image" className="mb-16 scroll-mt-24">
              ...
              <div className="text-text-secondary mb-6">
                <ol className="list-decimal list-outside ml-5 space-y-2 mb-6">
                  <li>Go to <Link to="/html-to-image" className="text-primary hover:underline">convertsnap.net/html-to-image</Link></li>
