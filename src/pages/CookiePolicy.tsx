...
export default function CookiePolicy() {
  ...
  return (
    <>
      <Helmet>
        <title>Cookie Policy — ConvertSnap.net</title>
        <meta name="description" content="ConvertSnap's Cookie Policy. Learn what cookies we use, why we use them, and how to manage your cookie preferences. We use minimal cookies." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.convertsnap.net/cookies" />
