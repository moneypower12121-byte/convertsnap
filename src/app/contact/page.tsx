          ...
          <div className="border-t border-border pt-16 flex flex-col md:flex-row gap-12 justify-between items-start">
            ...
            <div className="md:w-1/2">
               ...
               <div className="flex flex-wrap gap-4">
                 <Link href="/documentation" className="px-6 py-3 rounded-full bg-slate-100 text-slate-700 hover:bg-primary hover:text-white font-medium transition-colors">
                   Read Documentation &rarr;
                 </Link>
                 <Link href="/faq" className="px-6 py-3 rounded-full bg-slate-100 text-slate-700 hover:bg-primary hover:text-white font-medium transition-colors">
                   Check FAQ &rarr;
                 </Link>
                 <Link href="/blog" className="px-6 py-3 rounded-full bg-slate-100 text-slate-700 hover:bg-primary hover:text-white font-medium transition-colors">
                   Read Blog &rarr;
                 </Link>
               </div>
            </div>
