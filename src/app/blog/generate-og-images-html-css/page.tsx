  ...
  <div>
    ...
    <div class="cta">Try It Free →</div>
              ...
              <ol className="space-y-1">
                <li>Go to <Link href="/html-to-image">convertsnap.net/html-to-image</Link></li>
...
<meta name="twitter:image" content="https://www.yoursite.com/og-image.png">`}</code></pre>
              ...
              <p><em>(You can find ready-to-use HTML code for these in our <Link href="/html-to-image">HTML to Image tool</Link> by selecting "Load Templates")</em></p>
          ...
          <div className="my-16 bg-gradient-to-br from-[#0F172A] to-purple-900 rounded-3xl p-10 md:p-14 text-center text-white shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Link href="/html-to-image" className="inline-flex items-center justify-center h-14 px-8 rounded-xl bg-white text-purple-700 text-lg font-bold hover:bg-slate-50 transition-colors shadow-lg hover:shadow-xl hover:-translate-y-0.5 transform duration-200">
          ...
          <div className="mt-20 pt-10 border-t border-border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link href="/blog/automate-url-to-pdf-api" className="group bg-white rounded-2xl border border-border p-6 hover:shadow-md transition-all">
